  ...
  return (
    <div className="technologies">
      <div className="technologies--section--1">
        <div className="section--item--1" style={{'margin-left':`${mar1}`}} onClick={() => {setMar1('0'); setMar2('-10%'); setMar3('-10%')}} >
          ...
          <img src={technologiesImage1} alt="technology"/>
        </div>
        <div className="section--item--2" style={{'margin-left':`${mar2}`}} onClick={() => {setMar1('-10%'); setMar2('0'); setMar3('-10%')}}>
          <div className="item--text">
            <hr className="hr--line"/>
            <p>Oprema</p>
          ...
          <img src={technologiesImage2} alt="equipment" />
        </div>
        <div className="section--item--3" style={{'margin-left':`${mar3}`}} onClick={() => {setMar1('-10%'); setMar2('-10%'); setMar3('0');}}>
          <div className="item--text">
            <hr className="hr--line"/>
            <p>Osoblje</p>
          ...
          <img src={technologiesImage3} alt="reception" />
        </div>
      </div>
