      ...
      <div className="plan--section--1">
        ...
        <div className="price">
          <div className="price--item">
            ...
            <button className="price--item--conference--button" style={{'background-color':`${conBtnColor}`}} onClick={() => {setConPrice('2,400 RSD'); setConBtnColor('#F47064'); setDisabledConBtn('#F2E8E6')}}>Po satu</button><button className="price--item--conference--button" style={{'background-color':`${disabledConBtn}`}} onClick={() => {setConPrice('10,400 RSD'); setConBtnColor('#F2E8E6'); setDisabledConBtn('#F47064')}}>Po danu</button>
            <p>Kapacitet do 45 osoba | Novi Sad</p>
            <button className="price--item--plan--button">Rezervišite!</button>
          </div>
          <div className="price--item">
            <p><b>Učionica</b></p>
            <h3>{clsPrice} <span className="pdv">Sa PDV</span></h3>
            <button className="price--item--classroom--button" style={{'background-color':`${clsBtnColor}`}} onClick={() => {setClsPrice('4,200 RSD'); setClsBtnColor('#F47064'); setDisabledClsBtn('#F2E8E6')}}>Po satu</button><button className="price--item--classroom--button" style={{'background-color':`${disabledClsBtn}`}} onClick={() => {setClsPrice('16,200 RSD'); setClsBtnColor('#F2E8E6'); setDisabledClsBtn('#F47064')}}>Po danu</button>
